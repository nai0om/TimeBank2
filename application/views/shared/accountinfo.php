...
<? elseif (isset($user)) : ?>       
    <ul>
        <li>Welcome <span id="member_name"><?= HTML::anchor('user/profile/'.$user->id , $user->displayname ); ?></span></li>
...
<? elseif (isset($orguser)) : ?>       
    <ul>
        <li>Welcome <span id="member_name"><?= HTML::anchor('organization/profile/'.$orguser->id , $orguser->name ); ?></span></li>
