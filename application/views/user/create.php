            ...
            <?= Form::open('user/create',array('style'=>'margin-top:20px;display:inline;')); ?>
                <div id="leftSide">
                    ...
                    <p>
                        ...
                        <div class="error" style="margin:0px"><?= __(Arr::get($errors, 'first_name')); ?></div>
                    </p>
                    <p>
                        <label>นามสกุล</label>
                        <?= Form::input('last_name', HTML::chars(Arr::get($_POST, 'last_name'))); ?>
                        <div class="error" style="margin:0px"><?= __(Arr::get($errors, 'last_name')); ?></div>
                    </p>
                    <p>
                        <label>เบอร์โทรศัพท์</label>
                        <?= Form::input('phone', HTML::chars(Arr::get($_POST, 'phone'))); ?>
                        <div class="error" style="margin:0px"><?= __(Arr::get($errors, 'phone')); ?></div>
                    </p>
