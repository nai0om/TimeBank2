<div id="org">
 <div id="main" role="main">
		...
		<div class="column three">
			...
			<h4>เว็บไซต์</h4><span><a href="<?= phphelp::fixUrl($organization->website) ?>" target="_blank"><?= $organization->website ?></a></span>
			<h4>เฟสบุ๊ค</h4><span><a href="<?= phphelp::fixUrl($organization->facebook) ?>" target="_blank"><?= $organization->facebook ?></a></span>
