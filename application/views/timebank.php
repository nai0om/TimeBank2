<div id="main_timeBank">
 <div id="main" role="main">
	...
	<h3 class="title" align="center">บอกเล่าจากใจอาสา</h3>
		...
		<ol>
			<li><strong>1. สมัครบอกความตั้งใจให้เวลา</strong><p>กรอกชื่อ อีเมล รหัสผ่าน และฝากจำนวนชั่วโมงตามที่ตั้งใจ <br/><a href="http://www.youtube.com/watch?v=W3dbESdNf54">(ดูคลิปแนะนำ)</a></p></li>
			<li><strong>2. เลือกใช้เวลากับงานอาสาที่ตรงใจ</strong><p>ค้นหาและสมัครภารกิจจิตอาสาที่สอดคล้องกับเวลา ความสนใจ หรือทักษะของเรา <a href="http://www.youtube.com/watch?v=zxc8n6V4Eak">(ดูคลิปแนะนำ)</a></p></li>
			<li><strong>3. แบ่งปันประสบการณ์และยืนยันการใช้เวลา</strong><p>เล่าความประทับใจ การเรียนรู้ เรื่องราวจากภารกิจจิตอาสา และยืนยันเวลาที่ได้ใช้ไปแล้ว <a href="http://www.youtube.com/watch?v=_JWTzdpmbKQ">(ดูคลิปแนะนำ)</a></p></p></li>
		</ol>
        
		<h3 class="title">ขั้นตอนสร้างภารกิจจิตอาสา</h3>
		<ol>
			<li><strong>1. ให้ข้อมูลและแนะนำองค์กร</strong><p>สร้างบัญชีผู้ใช้ และบอกเล่าเรื่องราวเกี่ยวกับกลุ่ม/องค์กรอาสาของเรา</p></li>
			<li><strong>2. สร้างภารกิจ เปิดโอกาสใช้เวลาจิตอาสา</strong><p>ระบุรายละเอียดของภารกิจให้ครบถ้วน เช่นเวลาที่ใช้ ลักษณะงาน และทักษะที่ต้องการ</p></li>
